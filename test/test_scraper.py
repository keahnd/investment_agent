...
from agents.agent1_sentiment import (
    scrape_finviz,
...
yf_news = scrape_yahoo_finance("XST.TO")
...
# video_url = _resolve_channel_video_urls("https://www.youtube.com/@ProfGMarkets", n=4)
# transcript = fetch_youtube_transcript(video_url[3], "Prof G Markets")
# mentions = extract_ticker_mentions(transcript, "RBOT", "Global")
